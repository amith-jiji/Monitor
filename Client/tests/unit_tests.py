...
class TestMonitoring(BaseTest):
    def test_login_page(self, live_server):
        ...
        self.driver.find_element_by_tag_name('button').click()
        assert self.driver.current_url == live_server.url + reverse('dashboard')

        print("Unit Test of Login is Successful")
        return None

    def test_dashboard_page(self, live_server):
        self.driver.get(live_server.url + reverse('dashboard'))
        ...
        assert self.driver.current_url == live_server.url + reverse('camera', args=[1])

        print("Unit Test of Dashboard is Successful")
        return None

    def test_camera_page(self, live_server):
        self.driver.get(live_server.url + reverse('camera', args=[1]))
        ...
        assert self.driver.current_url == live_server.url + reverse('report', args=[1])

        print("Unit Test of Camera Live Stream is Successful")
        return None

    def test_report_page(self, live_server):
        self.driver.get(live_server.url + reverse('report', args=[1]))
        ...
        print("Unit Test of Report Generation is Successful")
        return None
